...
export default function DownloadPdf() {
    ...
    const { data: data2 = {}, error: error2, isValidating: loading2, mutate: mutate2 } = useSWR(`/api/income?tanggal=${selectedDate}`, fetcher)
    ...
    return (
        <div className="p-6 rounded-3xl bg-white flex flex-col">
            <label className="block mb-1 font-medium">Pilih Tanggal:</label>
            <input 
                type="date" 
                value={selectedDate} 
